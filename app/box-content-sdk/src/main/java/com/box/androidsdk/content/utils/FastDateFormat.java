...
/**
 * This code is copied in so we do not require the entire apache library. It is used
 * here in order to convert dates quickly and in a thread safe manner.
 *
 *
...
public class FastDateFormat extends Format {
    ...
    private static class TwoDigitYearField implements NumberRule {
         ...
         */
        public void appendTo(StringBuffer buffer, Calendar calendar) {
            appendTo(buffer, Integer.valueOf(calendar.get(Calendar.YEAR)));
        }
