...
import com.example.project11.activitys.HideCodeActivity;
import com.example.project11.activitys.MainActivity;
...
public class InformationAdapter extends RecyclerView.Adapter<InformationAdapter.ThongTinViewHolder> {
    ArrayList<Info> arrayList;
    MainActivity context;
    Dialog dialog;

    public InformationAdapter(ArrayList<Info> arrayList, MainActivity context) {
